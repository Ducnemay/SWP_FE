...
return (
    <div className="payment-blog-page">
        <AiOutlineCheckCircle style={{ color: 'green',fontSize: '100px',marginBottom: '20px',marginTop: '40px' }} />;
      ...
      <Link to="/transHis"><button className="payment-blog-button-cancle">Back to home</button></Link>
    </div>
